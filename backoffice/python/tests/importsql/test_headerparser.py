...
class HeaderParserTest(unittest.TestCase):
    def test_table_name(self):
        from backoffice.headerparser import get_table_name
        header_column = 'explanation.definition'
        self.assertEqual('explanation', get_table_name(header_column))
    def test_table_column_name_in_case_of_foreign_key(self):
        from backoffice.headerparser import table_column_name
